...
//Its working. The idea is about Annotations and then init doing with driver class. see how to
public class WordPressLogin_Annotation {
    ...
    public WordPressLogin_Annotation(WebDriver driver){
